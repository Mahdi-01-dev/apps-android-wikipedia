...
if __name__ == "__main__":
    ...
    parser.add_argument("--libs_versions", required=True, help="Path to libs.versions.toml")
    parser.add_argument("--output", required=True, help="Path to output file where external dependencies will be listed. Hint: app/libs/external_deps.txt")
